    ...
    <nav class="top-navbar" style="max-height: 55px; z-index: 1000;">
        <div class="d-flex justify-content-between align-items-center px-3 w-100">
            <div class="d-flex align-items-center gap-2">
                <div class="d-flex justify-content-center aling-items-center bg-white rounded-circle shadow-sm" style="width: 42px; height: 42px;">
                ...
                <div class="gap-0 d-flex flex-column">
                    ...
                    <small class="m-0" style="font-size: 0.75rem; opacity: 0.9;">Compras</small>
                </div>
            </div>
            <?= $this->element('ia') ?>
            <div class="nav-menu d-flex align-items-center gap-3 py-3">
                ...
                <?= $this->Html->link('<i class="bi bi-ticket"></i> Tickets', ['prefix' => false, 'controller' => 'Compras', 'action' => 'index'], ['escape' => false]) ?>
